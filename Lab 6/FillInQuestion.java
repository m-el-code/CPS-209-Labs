...
class FillInQuestion extends Question
{
    ...
    public FillInQuestion(String questionText)
    {
		...
		int position1 = questionText.indexOf(underscore);
		int position2 = questionText.indexOf(underscore, position1+1);
		String answer = questionText.substring(position1+1, position2);
		super.setAnswer(answer);
		String underscores = answer.replaceAll(".", "_");
		String text = questionText.replaceAll(answer, underscores);
